...
def caculate_clusters_b(image):
   ...
   # RandamBand=sorted( np.random.uniform(0.1 ,0.8,100))
    print()
...
parser.add_argument('--ImageSelecter', dest='Image_path', type=str, default='Binarization3.jpg', help='ex Binarization2.jpg')
